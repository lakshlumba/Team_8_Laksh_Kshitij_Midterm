...
object RidgeRegressionSGD {
    ...
    def main(args: Array[String]) {
        ...
        val sc = new SparkContext(new SparkConf().setAppName("RidgeRegressionWithSGD"))
        ...
        val stepSize = .00001
        val regParam = .01
        val model = RidgeRegressionWithSGD.train(parsedData, numIterations,stepSize,regParam)
